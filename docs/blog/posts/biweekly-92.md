...
在 2025 年的最后一期双周报里，我们将首次公布目前昆明湖 V3 架构在 SPEC CPU2006 上的性能评估结果！昆明湖 V3 自今年 8 月启动性能回归以来，已经完成了 11 次性能回归。这 11 次性能回归见证了香山团队齐心协力，对设计进行快速开发迭代的过程。现在，昆明湖 V3 在 SPEC 2006 测试中已经达到了 16.081 分，超过了 V2 的分数，V3 也已替代 V2 成为了香山仓库的新主线！

![Performance Regression Results for XiangShan Kunminghu](./figs/performance-regression.png)

在这一过程中，~~前端毫无疑问背了最大的锅~~最大的变化是 V3 的全新前端。新的前端大幅提高了指令带宽，现在每周期最多可预测 8 条分支、提供 32 条指令。

这一快速迭代的开发实践，正是香山敏捷开发理念的体现，其背后离不开香山基础设施的支持。我们相信，通过“开源”这一新理念、新方法，我们能够与整个社区共同前进，进一步提升开源处理器的性能标杆。
