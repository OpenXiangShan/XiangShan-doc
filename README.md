...
## 实习生计划 Interns
欢迎加入开源英才实习生计划（长期有效），具体见[根目录下pdf文件]("开源英才"实习生计划.pdf)。
...
香山始终坚持实事求是的原则，坚定我们希望建立开源平台与探索敏捷开发的初衷，不希望在宣传上出现任何可能导致误解的内容。

自香山在2021年6月举办的RISC-V中国峰会上正式发布以来，我们在社交媒体、自媒体、新闻媒体上看到了很多对香山处理器的报道，其中有一些是作者的“自我发挥”，存在误导读者的可能性。为此我们特意创建了一个辟谣专区，用来澄清一些广为流传的误会。
