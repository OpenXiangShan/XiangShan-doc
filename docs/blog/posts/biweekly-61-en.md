...
- **CHI Bus**
  ...
  - CHI Bridge: OpenNCB supports concurrency of more than 15 memory requests; under the OpenNCB + NoC framework, it supports up to 45 concurrent memory requests in a dual-core scenario
