...
On March 26, "XiangShan" + "Ruyi" were officially released at the ZGC Forum Annual Conference! Readers of the biweekly report should already be familiar with XiangShan, so we won't go into details here. Ruyi (openRuyi) is an operating system developed by the Institute of Software, Chinese Academy of Sciences (ISCAS), deeply adapted and optimized for XiangShan. This kind of software-hardware co-design is a key step in building the RISC-V ecosystem and one of the core competitiveness of the "XiangShan + Ruyi" open-source community. We hope to work together with the entire community to promote software-hardware co-innovation and build an open, inclusive, and prosperous RISC-V ecosystem.
