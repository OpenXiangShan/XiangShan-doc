...
2. 保存到 FLASH 中：
    ...
    - 在这种情况下不需要对负载额外添加恢复程序，但是需要参考 [NEMU Flash checkpoint CI](https://github.com/OpenXiangShan/NEMU/blob/cfa9bc87b4d726f53eb5ce6f2021da6e865e0dc5/.github/workflows/ci.yml#L72) 对配置和运行选项进行调整，此外该功能尚未适配 XS-GEM5 和香山 RTL 仿真，请按需使用。
