...
在 2025 年的最后一期双周报里，我们将首次公布目前昆明湖 V3 架构在 SPEC CPU2006 上的性能评估结果！昆明湖 V3 自今年 8 月启动性能回归以来，已经完成了 11 次性能回归。在这 11 次性能回归中，性能数据也发生了翻天覆地的变化。第一次性能回归中，SPEC 2006 INT 分数仅有 3.717 分/GHz；而在最新的性能回归中，V3 的性能已经超过了 V2。
...
这一快速迭代的开发实践，正是香山敏捷开发理念的体现，其背后离不开香山基础设施的支持。通过“开源”这一新理念、新方法，我们能够与整个社区共同前进，进一步提升开源处理器的性能标杆。
