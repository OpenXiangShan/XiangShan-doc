...
**我们将继续在HPCA'24会议期间同地举办香山项目的上手教程. Look forward to seeing you at HPCA'24 in Edinburgh, Scotland. Learn more on [the HPCA'24 Tutorial Page](https://xiangshan-doc.readthedocs.io/zh_CN/latest/tutorials/hpca24/).**

我们在MICRO'23会议期间同地举办了一次香山项目的上手教程，并介绍了第三代（昆明湖）架构的最新进展. We have hosted tutorials at MICRO'23 with latest update on the third generation (Kunminghu) architecture. Learn more on [the MICRO'23 Tutorial Page](https://xiangshan-doc.readthedocs.io/zh_CN/latest/tutorials/micro23/).
...
**香山处理器第二版（南湖架构）** 支持 RV64GCBK 指令集，已在 2023 年 11 月投片，在 14nm 工艺节点下频率达到 2GHz。南湖架构的设计代码开源地址在[这里](https://github.com/OpenXiangShan/XiangShan/releases/tag/v2.0)。南湖 V2 版本包含了 MBIST 等改进设计，已在 2023 年 2 月完成 RTL 代码冻结，并于 2023 年 4 月投片，设计代码开源地址在[这里](https://github.com/OpenXiangShan/XiangShan/releases/tag/v2.1)。南湖 V3 版本将包含更多的微结构、PPA改进，目前项目正在进行中。

The second generation (Nanhu architecture) supports the RV64GCBK instruction set and has been taped out in November 2023, achieving a frequency of 2GHz on a 14nm process node. The source code is [here](https://github.com/OpenXiangShan/XiangShan/releases/tag/v2.0).
